...
//비동기 방식으로 장바구니에 담자!!
function addCart(){
	var formData = $("#cart_form").serialize();//파라미터를 전송할 수 있는 문자열로 나열해줌 
	$.ajax({
                            ...
                            <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                                ...
                                <ol class="carousel-indicators">
                                	<%for(int i=0; i<product.getImageList().size();i++){ %>
		                                ...
		                                <%if(i >= 4) break; %>
		                                    <li <%if(i==0){ %>class="active"<%} %>  data-target="#product_details_slider" data-slide-to="<%=i %>"
		                                    style="background-image: url(/resources/data/addon/<%=image.getImage_id() %>.<%=image.getFilename()%>);"/>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="single_product_desc">
                            ...
                            <div class="single_product_ratings mb-15">
                            	<!-- 1~5사이의 값에 따라 조건을 부여하고, 미달점수의 경우 '-o'를 붙인다. -->
                            ...
                            <form id="cart_form" class="cart clearfix mb-50 d-flex">
                                ...
                                <button type="button" name="addtocart" value="5" class="btn cart-submit d-block" onClick="addCart(alert)">Add to cart</button>
                            </form>
