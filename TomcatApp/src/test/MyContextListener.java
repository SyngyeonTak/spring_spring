 ...
 * 감지하는 ServletContextListener를 이용하여 , ServletContext 객체에
 * 무언가를 작업해보자!
 * */
...
public class MyContextListener implements ServletContextListener{
	...
	public void contextInitialized(ServletContextEvent sc) {
		System.out.println("어플리케이션 톰캣시작과 함께 가동되었음");
		//어플리케이션의 전역적 정보를 가진, 세션보다도 훨씬 오래 살아가는 ServletContext에
		//비즈니스객체들(Service, DAO)를 올리자
	...
	public void contextDestroyed(ServletContextEvent sc) {
		System.out.println("어플리케이션 톰캣종료와 함께 종료되었음");
	}
